...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { data: @presentation.data, display_strategy: @presentation.display_strategy, fetch_strategy: @presentation.fetch_strategy, type: @presentation.type }
    end
  ...
  test "should update presentation" do
    patch :update, id: @presentation, presentation: { data: @presentation.data, display_strategy: @presentation.display_strategy, fetch_strategy: @presentation.fetch_strategy, type: @presentation.type }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
